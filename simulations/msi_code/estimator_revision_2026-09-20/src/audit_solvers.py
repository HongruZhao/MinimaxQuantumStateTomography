...
def run(output):
    ...
    mw_check = independent_validation(c, b, 256, mw, 'MW-PLS', mw_stats)
    ...
    omd_check = independent_validation(c, b, 256, omd, 'OMD', omd_stats)
    ...
    pdhg, pdhg_stats = forward(c, y, 256, method='pdhg', tol_fraction=1.,
                               eta_fraction=.005, maxiter=30000, regularized_tol_fraction=1e-7)
